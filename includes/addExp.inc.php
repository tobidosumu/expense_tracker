      ...
      <div class="modal-body">
        <form>
          <div class="mb-4">
            ...
            <textarea class="form-control" id="expNarrate" placeholder="Enter expense narration"></textarea>
            ...
            <input type="text" class="form-control text-black" id="expAmount" placeholder="Enter expense amount">
          </div>
        </form>
      </div>
